...
class ImageClassificationDataSet:
    def __init__(self, training_data: ImageClassificationData, testing_data: ImageClassificationData):
        self.training_data = training_data
        self.testing_data = testing_data

class EquipmentClassificationData:
    def __init__(self, category_one: ImageClassificationDataSet, category_two: ImageClassificationDataSet, category_three: ImageClassificationDataSet):
